...
export const chatSkill: Skill = {
  ...
  handler: async (ctx: BotContext, params: Record<string, unknown>): Promise<void> => {
    // response_text is already generated by the LLM router
    // The main message handler sends it — this is a no-op skill
    // In the future, this could do additional chat-specific logic
  },
};
